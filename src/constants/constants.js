export const projects = [
    ...
    description: "E-commerce page is a sleek web application that serves as the frontend for an online e-commerce platform. It offers users an engaging shopping experience with features like product catalog browsing, efficient product search, convenient filtering by category or color, and a responsive shopping cart. Users can quickly find and purchase products in a modern and user-friendly interface. Active development ensures ongoing enhancements and improvements.",
  ...
  {
    title: 'E-commerce page admin panel',
    description: "This is a dynamic admin panel crafted to streamline the management of e-commerce page. It empowers you with the ability to effortlessly add, edit, and categorize products. The panel provides a comprehensive view of all processed orders, while the homepage offers various statistics related to sales and product performance. Application also allows to login using Google account or email/password.",
    image: '/images/project-ecommerce-admin-panel.jpg',
    tags: ['Next.js', 'Tailwind', 'MongoDB'],
    source: 'https://e-commerce-admin-panel-ten.vercel.app/',
    visit: 'https://github.com/EdwardTymoshuk/e-commerce-admin-panel',
    id: 1,
  },
  {
    title: 'PostIt FullStack App',
    description: "This is a dynamic full stack web application, designed for creating and managing digital sticky notes. It offers users a streamlined note-taking experience with features like creating, editing, commenting, likes or unlikes and organizing notes. The app provides real-time updates and synchronization, making it ideal for collaborative note-taking. Its responsive design ensures accessibility across various devices. ",
  ...
  },
  {
    ...
    description: "This is a portfolio and CV (resume) showcase website designed to provide visitors with a comprehensive overview of my skills, experiences and contact information. This website serves as a professional online presence, featuring a responsive design, project portfolio, direct CV download, and a contact form for easy communication.",
...
export const TimeLineData = [
  ...
  { year: 2024, text: 'I am deepening my knowledge in such technologies as Next.Js, Tailwind and MongoDB and use them to create projects', },
];